                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">$<span class="count">Rp {{ number_format($orders[0]->pending) }}</span></div>
                                            <div class="stat-heading">Belum Dibayar</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="{{ asset('template/images/avatar/1.jpg')}}" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5469 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="{{ asset('template/images/avatar/2.jpg')}}" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5468 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="{{ asset('template/images/avatar/3.jpg')}}" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5467 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="{{ asset('template/images/avatar/4.jpg')}}" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5466 </td>
                                                ...
                                                <tr class=" pb-0">
                                                    ...
                                                    <td class="avatar pb-0">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="{{ asset('template/images/avatar/6.jpg')}}" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5465 </td>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="msg-received msg-container">
                                                    <div class="avatar">
                                                       <img src="{{ asset('template/images/avatar/64-1.jpg')}}" alt="">
                                            ...
                                            <li>
                                                <div class="msg-sent msg-container">
                                                    <div class="avatar">
                                                       <img src="{{ asset('template/images/avatar/64-2.jpg')}}" alt="">
                                                       <div class="send-time">11.11 am</div>
                                                    </div>
                                                    <div class="msg-box">
                                                        <div class="inner-box">
