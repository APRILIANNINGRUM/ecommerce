                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Belum Dibayar</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"p>Rp {{ number_format($orders[0]->pending) }}</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Dikirim</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $orders[0]->shipping }} Pesanan</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center" style="margin-left: 5px;">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $orders[0]->completeOrder }} Pesanan</div>
                                                </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CV. Kawan Sejati Website 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
