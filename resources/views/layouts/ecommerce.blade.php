		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						...
						<p>We are a platform that provides the needs for your skin, here we provide a variety of the best products to help treat your skin health,
						 improve the structure of the problem and also advanced treatments. Your review is the main thing for us.</p>
					</div>
				</div>
			...
			<div class="row footer-bottom d-flex justify-content-between align-items-center">
				<p class="col-lg-12 footer-text text-center">
                    ...
                    <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://byskin.id" target="_blank">BeautySkin</a>
				</p>
			</div>
		</div>
	</footer>
